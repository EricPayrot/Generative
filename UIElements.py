...
class app():
    def __init__(self,parent, height, width):
        ...
        self.output_canvas = Canvas(parent,bg='white', width=width, height=height)
...
class scratchpad():  
    ...
    def draw(self,event):
        ...
        if self.scratch_canvas.old_coords:
            ...
            self.TKitem=self.scratch_canvas.create_image((100,100),image=self.TKImage,anchor='center',tag='mosaic')
